...
### V1 vs V2
The versioning associated with the SageCam builds does not affect usage or functionality. The jump from v1 to v2 simply reflects a reduction of the number of parts, and is slightly more cost effective.
## SageMic
### Add-on
